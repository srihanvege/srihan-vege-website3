        ...
        >
          <div className="grid md:grid-cols-[1fr,220px] gap-6 items-center">
            ...
            <div className="justify-self-center md:justify-self-end">
              <div className="w-44 h-44 sm:w-48 sm:h-48 rounded-full bg-gradient-to-br from-slate-50 to-slate-200 dark:from-slate-800 dark:to-slate-700 flex items-center justify-center shadow-inner border border-slate-200 dark:border-slate-700">
